...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE_LAYER] = LAYOUT(
    ...
    KC_TRNS,  KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,                   KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_ENT,   KC_TRNS,
    KC_ESC,  MO(FUNC_LAYER), KC_LCTL, KC_LALT,   KC_SPC,   MO(MEDIA_LAYER)
  ),

  [FUNC_LAYER] = LAYOUT(
    KC_TRNS,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_TRNS,
    KC_TRNS,  KC_TAB,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  KC_TRNS,
